...
interface ConvertToUtf8Payload {
  fileName: string;
  fileContent: string; // Base64 encoded file content
  sourceEncoding?: string; // Optional, auto-detects encoding if not provided
}

interface ConvertToUtf8Response {
  success: boolean;
 ...
 * });
 */
export const convertToUtf8 = onCall<ConvertToUtf8Payload, Promise<ConvertToUtf8Response>>(
  {
    region: "us-central1",
    cors: true,
  },
